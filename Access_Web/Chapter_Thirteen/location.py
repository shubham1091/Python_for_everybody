...
the address= parameter that is properly URL encoded using the urllib.parse.urlencode() function as shown 
...
Turn In
Please run your program to find the place_id for this location: Saint-Petersburg Polytechnic Univesity

Make sure to enter the name and case exactly as above and enter the place_id and your Python code below. 
Hint: The first seven characters of the place_id are "ChIJQad ..."
