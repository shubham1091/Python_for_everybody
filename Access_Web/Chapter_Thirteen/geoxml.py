...
# Actual data: http://py4e-data.dr-chuck.net/comments_1771527.xml (Sum ends with 97)
...
# sample code that shows how to parse XML is geoxml.py. But since the nesting of the elements in our data
# is different than the data we are parsing in that sample code you will have to make real changes to the code.
